...
Public Class INVOICE_PAYMENT_NEW
    ...
    Private Sub INVOICE_PAYMENT_NEW_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Dim cmd As New SqlCommand("SELECT * FROM INVOICE_V WHERE INVOICE_ID=@INVOICE_ID", DbInterface.Connection)
            ...
            Using dr As SqlDataReader = cmd.ExecuteReader()
                ...
                End If
            End Using
            amount = (CInt(qty) * CDec(price)) - CDec(owe)
            ...
            Dim pamountR As New ReportParameter("Amount", amountR)
            ...
            Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "bbusystem.INVOICE_PAYMENT_NEW.rdlc"
            ...
            Me.ReportViewer1.LocalReport.SetParameters({staff, pinvoiceno, pincoiedate, pincoiedateE, psex, psexE, pdob, pdobE, pphone, pstudeytime, pdegree, pdegreeE, ppro,
                                                        ...
                                                        pbrshotname, powereason, pdescription, pamount, pamountR, ptotaldollar, ptotalbart, ptotalriel, ptotaldiscount,
