...
Public Class TRANSCRIPT_FORM
    ...
    Private Sub btnPreview_Click(sender As Object, e As EventArgs) Handles btnPreview.Click
        ...
        Dim parameters As ReportParameter() = {
            New ReportParameter("gpa", gpa.ToString("#.##")),
            New ReportParameter("id", student.StudentId),
            New ReportParameter("firstname", firstname),
            New ReportParameter("familyname", familyname),
            New ReportParameter("dob", dob),
            New ReportParameter("degree", degree),
            New ReportParameter("field", field.Trim),
            New ReportParameter("type", type.Trim),
            New ReportParameter("yearkm", CKhmerLunaaCalendar.GetKhmerYear()),
            ...
            New ReportParameter("description", txtDescription.Text.Trim)
        }
    ...
    Private Sub TRANSCRIPT_FORM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Setting()
        txtDescription.Text = IIf(rdoKhmer.Checked, "បានបញ្ចប់ការសិក្សាកម្រិត:", "Continuing the following degree:")
    End Sub
